  ...
  return (
    <div className="w-full max-w-md bg-white dark:bg-base-300 p-8 rounded-3xl shadow-2xl border border-base-200 dark:border-base-500">
      ...
      <form className="space-y-6" onSubmit={handleSubmit(handleRegister)}>
          ...
          <label className="cursor-pointer text-primary font-medium text-sm hover:underline">
            ...
            {/* <input
              ...
              {...register("profileImage", {
                ...
                validate: {
                  fileSize: (file) => (file && file[0] && file[0].size <= 2 * 1024 * 1024) || "Image must be under 2MB",
                  fileType: (file) => (file && file[0] && ["image/jpeg", "image/png", "image/webp"].includes(file[0].type)) || "Only JPG, PNG, WEBP allowed"
                }
              })}
        ...
        {/* Name */}
        <div>
          <label className="block text-base font-medium text-gray-700 dark:text-gray-300 mb-1.5">Full Name</label>
          <input
            type="text"
        ...
        {/* Gender */}
        <div>
          <label className="block text-base font-medium text-gray-700 dark:text-gray-300 mb-1.5">Gender</label>
        ...
        {/* Confirm Password */}
        <div>
          <label className="block text-base font-medium text-gray-700 dark:text-gray-300 mb-1.5">Confirm Password</label>
          <div className="relative">
            <input
