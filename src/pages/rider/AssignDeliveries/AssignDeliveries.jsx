...
const AssignDeliveries = () => {
    ...
    const {data : parcels = [],refetch} = useQuery({
        ...
        queryFn: async() =>{
            const res = await axiosSecure.get(`/parcels/rider?deliveryStatus=rider-assigned&riderEmail=${user?.email}`)
            return res.data
        }
    })
    ...
    const handleRiderStatusbtn = async(parcel,status)=>{
        ...
        axiosSecure.patch(`/parcels/${parcel._id}/rider`, statusInfo)
            .then(res => {
                            ...
                            <td>
                                {
                                    parcel.deliveryStatus === 'rider-assigned'
                                        ? <>
                                            <button
                                               onClick={()=>handleRiderStatusbtn(parcel,'rider-arriving')}
